...
int main()
{
    ...
    PM_manage(params,"str2",STRING_TYPE,0);
    PM_manage(params,"str3",STRING_TYPE,0);
    PM_manage(params,"str4",STRING_TYPE,0);
    PM_manage(params,"str5",STRING_TYPE,0);
    PM_manage(params,"str6",STRING_TYPE,0);
    PM_manage(params,"str7",STRING_TYPE,0);
    PM_manage(params,"str8",STRING_TYPE,0);
    PM_manage(params,"int1",INT_TYPE,0);
    PM_manage(params,"int2",INT_TYPE,0);
    PM_manage(params,"int3",INT_TYPE,0);
    ...
    PM_manage(params,"b1",BOOLEAN_TYPE,0);
    PM_manage(params,"b2",BOOLEAN_TYPE,0);
    PM_manage(params,"b3",BOOLEAN_TYPE,0);
    PM_manage(params,"l1",LIST_TYPE,0);
    PM_manage(params,"l2",LIST_TYPE,0);
    PM_manage(params,"l3",LIST_TYPE,0);
    PM_manage(params,"l4",LIST_TYPE,0);
