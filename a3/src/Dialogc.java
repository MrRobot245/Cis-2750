...
public class Dialogc extends JFrame implements ActionListener
{
    ...
    native int DialogcParse(String filePath);
    ...
    private String rtOptions="";
    private String yadCString="";
    JTextArea editArea = new JTextArea(6, 20);
    JRadioButtonMenuItem nButt = new JRadioButtonMenuItem("Normal");
    JRadioButtonMenuItem yButt = new JRadioButtonMenuItem("YACC");
    private void guiUI()
    {
        //All Mah Icons
        ...
        cButton.addActionListener(new ActionListener()
        {
            public void actionPerformed(ActionEvent e) {
                ...
                else
                {
                    ...
                    {
                        DialogcCreate(60);
                        rVal=DialogcParse(curFilePath);
                        if(rVal==2)
                        {
                            Dialogc.infoBox("Parse Error!\nCanceling","Error");
                        }
                        else
                        {
                            DialogcManage();
                    ...
                    else
                    {
                        //YADC
                        try {
                            yadCString="./yadc "+curFilePath+" "+ "IDE "+curWDir;
                            System.out.println(yadCString);
                            Process p = Runtime.getRuntime().exec(yadCString);
                            //./yadc myGui.config test /home/nathan/Desktop/2750/a3
                        }
        ...
        public void actionPerformed(ActionEvent E) {
            ...
            {
                options = JOptionPane.showInputDialog("Enter options");
            }
            if(E.getActionCommand()=="Run-Time options")
            {
                rtOptions = JOptionPane.showInputDialog("Enter options");
            }
