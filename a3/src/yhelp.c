/*
* ------------------------------------------------------------------
*  S.c - Wrapper for C code to generate GUI's dynamically
*
...
//Parse the file
 int  DialogcParse( char * filePath)
{
	int rVal=0;
...
int main(int argc, char** argv)
{
    ...
    DialogcCreate(60);
    DialogcParse(filename);
    DialogcManage();
    DialogcParse(filename);
    DialogcPeek();
    DialogcWrite(subDir);
    DialogcCompile(subDir);
    DialogcCRun(subDir);
